...
import { Video, Calendar, Clock, Users, Radio, Search, PlayCircle, BookOpen, User } from 'lucide-react';
...
export default function LiveSessions() {
  ...
  const fetchLiveSessions = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/teacher/live-sessions', { credentials: 'include' });
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50">
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            Manage and monitor the live sessions you host for your courses.
          </motion.p>
        </div>
      </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 bg-white border border-indigo-100 rounded-xl px-4 py-3 shadow-sm">
            <div>
              <p className="font-semibold text-gray-900">Need to schedule a live session?</p>
              <p className="text-sm text-gray-600">Live sessions are created inside each course. Jump to your courses to add one.</p>
            </div>
            <Button
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 text-sm text-gray-600">
            ...
            <Button variant="outline" className="gap-2" onClick={() => router.push('/teacher/students')}>
