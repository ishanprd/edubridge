...
const Sidebar = () => {
  ...
  const sidebarItems = [
    { id: "overview", label: "Overview", icon: Home, href:'/teacher'},
    { id: "courses", label: "My Courses", icon: BookOpen, href:'/teacher/courses'},
    { id: "live-sessions", label: "Live Sessions", icon: Monitor, href:'/teacher/live-sessions'},
    { id: "students", label: "View All Students", icon: Users, href:'/teacher/students'},
    { id: "feedback", label: "Feedback", icon: MessageSquare, href:'/teacher/feedbacks'},
  ]
