...
export default function Feedback() {
  ...
  const fetchFeedbacks = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/teacher/ratings', { credentials: 'include' });
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50 to-yellow-50">
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            View all your course reviews and ratings in one place.
          </motion.p>
        </div>
      </motion.div>
                      ...
                      <div className="flex-1 p-6">
                        <div className="mb-4">
                          ...
                          <div className='text-sm my-2'>
                            - {feedback.userId.firstName} {feedback.userId.lastName} ({feedback.userId.email})
                          </div>
                      ...
                      <div className="flex items-center justify-center p-6 bg-gradient-to-br from-gray-50 to-gray-100 lg:w-64">
                        <div className="text-center space-y-3 w-full">
                          <Button
                            ...
                            onClick={() => router.push(`/teacher/courses/${feedback.courseId?._id}`)}
                          >
                            View Course
