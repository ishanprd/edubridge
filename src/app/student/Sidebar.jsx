...
const Sidebar = () => {
  ...
  const sidebarItems = [
    ...
    { id: "courses", label: "Courses", icon: BookOpen, href:'/student/courses'},
    { id: "mycourses", label: "My Courses", icon: BookOpen, href:'/student/my-courses'},
    { id: "live-sessions", label: "Live Sessions", icon: Monitor, href:'/student/live-sessions'},
    { id: "feedback", label: "Feedback", icon: MessageSquare, href:'/student/feedbacks'},
  ]
